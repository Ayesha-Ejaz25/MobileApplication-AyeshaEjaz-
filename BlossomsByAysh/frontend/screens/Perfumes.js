...
const WOMEN_PRODUCTS = [
  { id: 'fregf1', name: 'Freg F 1', price: 3499, rating: 4.5, images: [
  ...
  { id: 'fregf2', name: 'Freg F 2', price: 3999, rating: 4.2, images: [
      require('../../assets/images/fregF2.0.jpg'),
      require('../../assets/images/fregF2.1.jpg'),
      require('../../assets/images/fregF2.2.jpg'),
    ],  description: 'Refreshing floral fragrance, perfect for daily wear.'
  },
  { id: 'fregf3', name: 'Freg F 3', price: 3299, rating: 4.6, images: [
      require('../../assets/images/fregF3.0.jpg'),
      require('../../assets/images/fregF3.1.jpg'),
      require('../../assets/images/fregF3.2.jpg'),
    ],  description: 'Refreshing floral fragrance, perfect for daily wear.'
  },
  { id: 'fregf4', name: 'Freg F 4', price: 3799, rating: 4.3, images: [
      require('../../assets/images/fregF4.0.jpg'),
      require('../../assets/images/fregF4.1.jpg'),
    ],  description: 'Refreshing floral fragrance, perfect for daily wear.'
  },
];
...
// Men Perfumes
const MEN_PRODUCTS = [
  { id: 'fregm1', name: 'Freg M 1', price: 3599, rating: 4.5, images: [
      require('../../assets/images/fregM1.0.jpg'),
      require('../../assets/images/fregM1.1.jpg'),
      require('../../assets/images/fregM1.2.jpg'),
    ] ,  description: 'Refreshing floral fragrance, perfect for daily wear.'
  },
  { id: 'fregm2', name: 'Freg M 2', price: 3899, rating: 4.2, images: [
      require('../../assets/images/fregM2.0.jpg'),
      require('../../assets/images/fregM2.1.jpg'),
      require('../../assets/images/fregM2.2.jpg'),
    ],  description: 'Refreshing floral fragrance, perfect for daily wear.'
  },
  { id: 'fregm3', name: 'Freg M 3', price: 3199, rating: 4.6, images: [
      require('../../assets/images/fregM3.0.jpg'),
      require('../../assets/images/fregM3.1.jpg'),
      require('../../assets/images/fregM3.2.jpg'),
    ],  description: 'Refreshing floral fragrance, perfect for daily wear.'
  },
  { id: 'fregm4', name: 'Freg M 4', price: 3999, rating: 4.3, images: [
      require('../../assets/images/fregM4.0.jpg'),
      require('../../assets/images/fregM4.1.jpg'),
      require('../../assets/images/fregM4.2.jpg'),
    ],  description: 'Refreshing floral fragrance, perfect for daily wear.'
  },
];
...
export default function Perfumes() {
  ...
  const products = selected === 'Women' ? WOMEN_PRODUCTS : MEN_PRODUCTS;
  ...
  const onPressIn = (id) => {
    Animated.spring(scaleMap[id], { toValue: 0.97, useNativeDriver: true }).start();
  };
  const onPressOut = (id) => {
    Animated.spring(scaleMap[id], { toValue: 1, friction: 6, useNativeDriver: true }).start();
  };
  ...
  return (
    <View style={styles.screen}>
      ...
      <View style={styles.titleRow}>
        <Text style={styles.title}>Perfumes Collection</Text>
        ...
        <View style={styles.selectorWrap}>
          ...
          {dropdownOpen && (
            <View style={styles.dropdown}>
              <TouchableOpacity onPress={() => { setSelected('Women'); setDropdownOpen(false); }} style={styles.option}>
                <Text style={styles.optionText}>Women</Text>
              </TouchableOpacity>
              <TouchableOpacity onPress={() => { setSelected('Men'); setDropdownOpen(false); }} style={styles.option}>
