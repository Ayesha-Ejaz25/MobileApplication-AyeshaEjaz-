...
// Winter Pret Products with images array
const PRET_PRODUCTS = [
  { id: 'pretw1', name: 'Pret W 1', price: 3499, rating: 4.5, images: [
  ...
  { id: 'pretw2', name: 'Pret W 2', price: 3999, rating: 4.2, images: [
  ...
  { id: 'pretw3', name: 'Pret W 3', price: 3299, rating: 4.6, images: [
      require('../../assets/images/PretW3.0.jpg'),
      require('../../assets/images/PretW3.1.jpg'),
      require('../../assets/images/PretW3.2.jpg'),
    ],
  description: 'Warm and cozy winter cloth, perfect for cold weather.'
  },
  { id: 'pretw4', name: 'Pret W 4', price: 3799, rating: 4.3, images: [
      require('../../assets/images/PretW4.0.jpg'),
      require('../../assets/images/PretW4.1.jpg'),
      require('../../assets/images/PretW4.2.jpg'),
    ],
  description: 'Warm and cozy winter cloth, perfect for cold weather.'
  },
];

// Winter Unstitched Products with images array
const UNSTITCHED_PRODUCTS = [
  { id: 'unw1', name: 'UnW 1', price: 2499, rating: 4.1, images: [
  ...
  { id: 'unw2', name: 'UnW 2', price: 2799, rating: 4.0, images: [
  ...
  { id: 'unw3', name: 'UnW 3', price: 2199, rating: 4.4, images: [
      require('../../assets/images/UnW3.0.jpg'),
      require('../../assets/images/UnW3.1.jpg'),
      require('../../assets/images/UnW3.2.jpg'),
    ],
  description: 'Warm and cozy winter cloth, perfect for cold weather.'
  },
  { id: 'unw4', name: 'UnW 4', price: 2899, rating: 4.2, images: [
      require('../../assets/images/UnW4.0.jpg'),
      require('../../assets/images/UnW4.1.jpg'),
      require('../../assets/images/UnW4.2.jpg'),
    ],
  description: 'Warm and cozy winter cloth, perfect for cold weather.'
  },
];
...
export default function Winter() {
  ...
  const [selected, setSelected] = useState('Pret'); // 'Pret' or 'Unstitched'
